    ...
    public partial class SettingsDialog : Window
    {
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (App.Repository == null)
            {
                ...
                {
                    await App.DialogService.ShowWarningAsync("SettingsDialogHost",
                ...
                catch (Exception ex)
                {
                    ...
                    await App.DialogService.ShowErrorAsync("SettingsDialogHost",
        ...
        // red, etc.) no debe impedir guardar localmente, que es lo que ya garantiza App.SaveApiKeys/
        // ReconnectAsync justo antes de llamar a este método.
        private async System.Threading.Tasks.Task SyncToAccountAsync()
        {
            try
            {
                await App.AccountService.SaveSettingsAsync(new UserSettings
                {
                    ...
                    ScanDexToken = TxtScanDex.Text.Trim(),
                    IgdbClientId = TxtIgdbClientId.Text.Trim(),
                    IgdbClientSecret = TxtIgdbClientSecret.Text.Trim(),
                    RawgApiKey = TxtRawg.Text.Trim(),
                    TheGamesDbApiKey = TxtGamesDb.Text.Trim()
                });
            }
            catch (Exception ex)
            {
        ...
        private async void BtnSaveCollectionName_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("SettingsDialogHost", $"No se ha podido guardar el nombre:\n{ex.Message}");
            }
        }
        ...
        private async void BtnSaveConnection_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (connectionString.Length == 0)
            {
                await App.DialogService.ShowWarningAsync("SettingsDialogHost", "Introduce una cadena de conexión.", "Conexión a la base de datos");
                return;
            }
            ...
            try
            {
                ...
                await App.DialogService.ShowInfoAsync("SettingsDialogHost", "Conexión establecida correctamente.", "Conexión a la base de datos");
            }
            catch (Exception ex)
            {
                LoggingService.LogError("Conectar con la base de datos Neon", ex);
        ...
        private async void BtnFindDuplicates_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (groups.Count == 0)
                {
                    await App.DialogService.ShowInfoAsync("SettingsDialogHost",
            ...
            catch (Exception ex)
            {
                ...
                await App.DialogService.ShowErrorAsync("SettingsDialogHost", $"No se ha podido completar la búsqueda:\n{ex.Message}");
            }
        }
        ...
        private async void BtnImport_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var importer = App.ImportService;
                ...
                var guessed = ImportPreviewBuilder.GuessMapping(headers);
                ...
                await App.DialogService.ShowInfoAsync("SettingsDialogHost", msg, "Importar colección");
            }
            catch (Exception ex)
            {
                LoggingService.LogError("Importar colección desde CSV/Excel", ex);
                await App.DialogService.ShowErrorAsync("SettingsDialogHost", $"No se ha podido importar el archivo:\n{ex.Message}");
            }
        }
    }
}
